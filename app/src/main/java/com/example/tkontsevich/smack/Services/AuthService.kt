...
import com.example.tkontsevich.smack.Untilities.URL_REGISTER
import com.example.tkontsevich.smack.Untilities.URL_CREATE_USER
import com.example.tkontsevich.smack.Untilities.URL_LOGIN
import com.example.tkontsevich.smack.Untilities.URL_GET_USER
        ...
        IdlingResourceHolder.networkIdlingResource.increment()
            ...
            val loginRequest = object : JsonObjectRequest(Method.POST, URL_LOGIN, null, Response.Listener { response ->
                try {
                    ...
                    Log.d("JSON", "EXS: " + e.localizedMessage)
                    complete(false)
                } finally {
                    IdlingResourceHolder.networkIdlingResource.decrement()
                }

...
import com.example.tkontsevich.smack.Adapters.MessageAdapter
...
import com.example.tkontsevich.smack.Services.MessageService
import com.example.tkontsevich.smack.Services.UserDataService
import com.example.tkontsevich.smack.Untilities.BROADCAST_USER_DATA_CHANGE
import com.example.tkontsevich.smack.Untilities.SOCKET__URL
...
class MainActivity : AppCompatActivity() {
    ...
    val socket = IO.socket(SOCKET__URL)
        ...
        if (App.prefs.isLoggedIn) {
            runOnUiThread {
                ...
                if (channelId == selectedChannel?.id) {
                    ...
                    val newMassage = Message(msgBody, userName, channelId, userAvatar, userAvatarColor, id,
                            timeStamp)
                    MessageService.messages.add(newMassage)
